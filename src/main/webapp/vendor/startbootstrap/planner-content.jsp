                  ...
                  <form onsubmit="return false">
                    <div class="form-row">
                      ...
                      <div class="form-group col-md-2 text-center">
                        <button class="rounded-circle border-0 btn-lg" id="add-selected"><i class="fas fa-plus"></i></button>
                      </div>
                    </div>
                  </form>
                </div>
              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                  <form id="submit-plan" onsubmit="return false">
                    ...
                    <input type="number" class="form-control" id="semesters" min="1" max="12" required>
                    <br>
