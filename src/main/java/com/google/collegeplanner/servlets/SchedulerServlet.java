...
public class SchedulerServlet extends HttpServlet {
   ...
   * courses.
   * @param classes The JSONArray of courseIds that have been selected to be scheduled
   */
  private void prepareLists(JSONArray classes) {
    ...
    for (JSONArray obj : (JSONArray) classes.toArray()) {
      ...
      courses.add(convertJSONOfSectionsToSectionArrayList(jsonArray));
    }
  }

  /**
   * Returns a JSONObject representing the schedules the
   ...
   * sections.
   * @param json The JSONArray of sections that will be converted into
   * an ArrayList of sections
   */
  private ArrayList<Section> convertJSONOfSectionsToSectionArrayList(JSONArray json) {
